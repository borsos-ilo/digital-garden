...
![Systematic learning - diagram](src/content/posts/_images/nauka_systematyczna.png)

#### Example

I begin my psychology studies with an "Introduction to Psychology" course and by reading a foundational textbook (for example, ["Psychology and Life"](https://www.amazon.com/Psychology-Life-20th-Richard-Gerrig/dp/0205854593) by P. Zimbardo or ["Academic Psychology"](https://lubimyczytac.pl/ksiazka/115005/psychologia-akademicka-podrecznik-tom-1) edited by D. Doliński and J. Strelau).
...
After mastering the basics, I can move on to more specific topics (e.g., [biological bases of psychology](https://www.amazon.com/Biological-Psychology-James-W-Kalat/dp/1337408204), [cognitive psychology](https://www.amazon.com/Cognitive-Psychology-Connecting-Mind-Research/dp/1337408271), [developmental psychology](https://www.amazon.com/Developmental-Psychology-Childhood-Adolescence-David/dp/1133491234))—and the whole process repeats. Ultimately, this allows me to gain both broad knowledge of psychology as a whole and the opportunity to find a niche in which I want to specialize.

![Books - "systematic" learning tools](src/content/posts/_images/ksiazki.png)
...
I would call my recent [process of building the FlyCards app](https://ilonaborsos.com/flycards-signup) "point learning." In short, I was frustrated by the inefficient process of creating high-quality flashcards for new Hungarian words (the kind that include images, translations, and example sentences), so I decided to write an iOS app to solve my specific problem. I am one of those people stuck in [tutorial hell](https://www.reddit.com/r/learnprogramming/comments/qrlx5m/what_exactly_is_tutorial_hell/)—fortunately, with ChatGPT or Claude at my disposal, I can quickly gain the knowledge I lack to solve my problem. In this case, my learning looked something like this:

![Point learning - diagram](src/content/posts/_images/nauka_punktowa.png)
...
If I apply a systematic approach to situations where I should be learning point-by-point, I won't solve a critical problem in a short amount of time. In many cases, when I [have to choose between time and accuracy](https://www.youtube.com/watch?v=vkIds5Xxki4), time turns out to be the more important factor.

When learning point-by-point, I may fall into the trap of thinking I have understood the problem in its entirety—and I must remember that I haven't. [I am still a Visitor, not a Native](https://fsbooks.s3.ca-central-1.amazonaws.com/the+great+mental+models/1+general+thinking+concepts/sample_chapter.pdf).

I don't think either approach is inherently better or worse—they are simply tools I can use for appropriate purposes.

## For further exploration

1. Detailed learning techniques within the systematic and point learning processes.
2. Is there a better name for this already created by someone wiser?
3. Knowledge vs. Confidence
